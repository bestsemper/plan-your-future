          ...
          <div className="max-h-64 overflow-y-auto p-1.5 space-y-0.5" role="listbox">
            {emptyLabel && (
              <button
                ...
                className={`w-full text-left px-3 py-2 text-sm rounded-lg cursor-pointer transition-colors ${value === '' ? 'bg-uva-blue/10 text-uva-blue font-semibold' : 'text-text-primary hover:bg-hover-bg'}`}
              >
                {emptyLabel}
              </button>
            )}
            ...
            {filteredOptions.map((option) => (
              <button
                ...
                className={`w-full text-left px-3 py-2 text-sm rounded-lg cursor-pointer transition-colors flex items-center justify-between gap-2 ${value === option.value ? 'bg-uva-blue/10 text-uva-blue font-semibold' : 'text-text-primary hover:bg-hover-bg'}`}
              >
