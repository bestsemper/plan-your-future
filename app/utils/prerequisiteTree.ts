...
const departmentNames: { [key: string]: string } = {
  ACCT: "Accounting",
  ALAR: "African Languages and Literatures",
  ...
  CELL: "Cell Biology",
  CGBM: "Computational Genomics and Bioinformatics",
  ...
  EDIS: "Education - Instructional Strategies",
  EDLF: "Education - Leadership and Foundations",
  ENCW: "English - Creative Writing",
  ENGL: "English",
  ENGR: "Engineering",
  ENWR: "English - Writing",
  EVAT: "Environmental Sciences - Atmospheric",
  EVEC: "Environmental Sciences - Ecology",
  EVGE: "Environmental Sciences - Geology",
  EVHY: "Environmental Sciences - Hydrology",
  EVSC: "Environmental Sciences",
  FREN: "French",
  GBUS: "Global Business",
  GCNL: "Global Clinical",
  GDS: "Global Data Science",
  GERM: "German",
  GETR: "German Translation",
  GNUR: "Global Nursing",
  GREE: "Greek",
  HBIO: "Human Biology",
  HEBR: "Hebrew",
  ...
  HIEU: "History - Europe",
  HIND: "Hindi",
  ISBU: "International Studies - Business",
  ...
  KINE: "Kinesiology",
  KOR: "Korean",
  LAR: "Latin American Studies",
  LASE: "Latin American Studies - Entrepreneurship",
  LATI: "Latin",
  LAW: "Law",
  LING: "Linguistics",
  LNGS: "Languages",
  ...
  PHY: "Physics",
  PHYS: "Physics",
  PLAC: "Planning - Academic",
  PLAD: "Planning - Administrative",
  PLAN: "Planning",
  PLAP: "Planning - Applied",
  PLCP: "Planning - Community Planning",
  PLIR: "Planning - International Relations",
  PLPT: "Planning - Property and Trust",
  POL: "Politics",
  PORT: "Portuguese",
  PSHM: "Psychology - Management",
  PSHP: "Psychology - Professional",
  PSYC: "Psychology",
  RELA: "Religion - Asian",
  RELB: "Religion - Buddhist Studies",
  RELC: "Religion - Christianity",
  RELG: "Religion - General",
  RELH: "Religion - Hebrew Bible",
  RELJ: "Religion - Jewish Studies",
  RUSS: "Russian",
  RUTR: "Russian Translation",
  SANS: "Sanskrit",
  SOC: "Sociology",
  SPAN: "Spanish",
  STAT: "Statistics",
